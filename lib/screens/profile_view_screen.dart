                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _buildInfoField(
                                'Department',
                                controller.employeeProfile.value!.departmentName ?? '--',
                                mq,
                              ),
                              _buildInfoField(
                                'Designation',
                                controller.employeeProfile.value!.designationTitle ?? '--',
                                mq,
                              ),
                              _buildInfoField(
                                'Shift',
                              ...
                              _buildInfoField(
                                'Shift Time',
                                controller.employeeProfile.value!.formattedShiftTime,
                                mq,
                              ),
                              _buildInfoField(
                                'Join Date',
                                controller.employeeProfile.value!.formattedJoinDate,
                                mq,
                              ),
                              _buildInfoField(
                                'Teams',
                          ...
                          () => AppButton(
                            ...
                            onPressed: () {
                              if (formKey.currentState!.validate()) {
                                final updatedData = {
                                  "employee_id": controller.employeeProfile.value!.employeeId,
                                  "fullname": controller.fullNameController.text,
                                  "father_name": controller.fatherNameController.text,
                                  "dob": controller.dobController.text,
                                  "email": controller.emailController.text,
                                  "phone": controller.phoneController.text,
                                  "cnic": controller.cnicController.text,
                                  "address": controller.addressController.text,
                                  "profile_picture": controller.selectedImageBase64.value,
                                };
